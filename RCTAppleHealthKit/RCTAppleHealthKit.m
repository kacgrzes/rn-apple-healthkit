...
RCT_EXPORT_METHOD(getMindfulSamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self mindfulness_getMindfulSamples:input callback:callback];
}
